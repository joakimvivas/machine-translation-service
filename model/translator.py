...
class Translator():
    ...
    def translate(self,source,target,text):
        ...
        batch = self.models[route][1].prepare_seq2seq_batch(src_text=list([text]),return_tensors='pt')
...
def HTTPTranslate(textToTranslate,toLang="Spanish",fromLang="English"):
    ...
    try:
        ...
        return 500,"Could'nt connect to the server at the moment!"
    except Exception as ex:
        return 504,"Undefined Error"
